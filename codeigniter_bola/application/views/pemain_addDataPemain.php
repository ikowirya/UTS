		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<?php echo form_open_multipart('pemain/addDataPemain/'.$this->uri->segment(3)); ?>
								...
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" style="width: 30%"> 
									</div>
